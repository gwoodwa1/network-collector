...
| `junos/58-junos-declarative-vrf.yaml` | Junos VRF desired state with explicit instance type, RD/route-target replacement, dependency refusal, inverse rollback, and `--check` |
